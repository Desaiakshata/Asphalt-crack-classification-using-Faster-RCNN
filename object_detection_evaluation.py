        ...
        if self._evaluate_precision_recall:
          display_name = (
              ...
              'PerformanceByCategory/Precision@{}IOU/{}'.format(
                  self._matching_iou_threshold, category_name))
          #print('precisiiiiiiiion',pascal_metrics[display_name],per_class_precision[idx])
          ...
          display_name = (
              ...
              'PerformanceByCategory/Recall@{}IOU/{}'.format(
                  self._matching_iou_threshold, category_name))
          #print('recaaaaaalllllll',pascal_metrics[display_name],per_class_precision[idx])
...
class ObjectDetectionEvaluation(object):
  ...
  def evaluate(self):
    ...
    for class_index in range(self.num_class):
      ...
      precision, recall, precision_class, recall_class = metrics.compute_precision_recall(
      ...
      self.precisions_per_class[class_index] = precision_class
      self.recalls_per_class[class_index] = recall_class
