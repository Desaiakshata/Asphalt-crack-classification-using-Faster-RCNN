...
def evaluate(create_input_dict_fn, create_model_fn, eval_config, categories,
  ...
  def _process_batch(tensor_dict, sess, batch_index, counters,
    ...
    if True: #batch_index < eval_config.num_visualizations:
      tag = 'image-{}'.format(batch_index)
      box_list_left_load,extent_left,box_list_right_load,extent_right,block,extent_block,b1,b1_extent=eval_util.visualize_detection_results(
          result_dict,
          tag,
          global_step,
          categories=categories,
          summary_dir=eval_dir,
          export_dir='/content/im',
      ...
      np_box_list_ops.write_sheet(filename,batch_index,box_list_left_load,extent_left,box_list_right_load,extent_right,block,extent_block,b1,b1_extent)
