...
def compute_precision_recall(scores, labels, num_gt):
  ...
  sum_true_positives = np.sum(true_positive_labels)
  sum_false_positives = np.sum(false_positive_labels)
  #print('true_positive_labels',true_positive_labels)
  #print('false_positive_labels',false_positive_labels)
  #print('sum_true_positives',sum_true_positives)
  #print('sum_false_positives',sum_false_positives)
  #print('num_gt',num_gt)
  precision = cum_true_positives.astype(float) / (
      cum_true_positives + cum_false_positives)
  recall = cum_true_positives.astype(float) / num_gt
  precision_class = sum_true_positives.astype(float)/(sum_true_positives.astype(float) + sum_false_positives.astype(float))
  recall_class = sum_true_positives.astype(float) / num_gt
  return precision, recall, precision_class, recall_class
