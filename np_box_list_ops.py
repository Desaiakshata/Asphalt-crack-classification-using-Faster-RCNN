...
def write_sheet(filename,j,box_list_left_load,extent_left,box_list_right_load,extent_right,block,extent_block,b1,b1_extent):
    #print(box_list_left_load,box_list_right_load)
    level_extent = [box_list_left_load,extent_left,box_list_right_load,extent_right,block,extent_block,b1,b1_extent]
    k=0
    if j==0:
        wb = Workbook()
