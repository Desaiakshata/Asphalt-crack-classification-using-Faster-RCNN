...
class PerImageEvaluation(object):
  ...
  def compute_object_detection_metrics(self,
    ...
    #print('no of detected boxes11', len(detected_boxes))
  ...
  def _compute_tp_fp(self,
    ...
    #print('len(result_tp_fp_labels)',len(result_tp_fp_labels))
  ...
  def _compute_tp_fp_for_single_class(self,
    ...
    def compute_match_iou(iou, groundtruth_nongroup_of_is_difficult_list,
      ...
      Args:
        ...
        is_box: boolean that specifies if currently boxes or masks are
          processed.
      """
      #print('iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiou',iou)
      ...
      #print('is_gt_detected',is_gt_detected)
      #print('tp_fp_labels',tp_fp_labels)
      #print('max_overlap_gt_ids',max_overlap_gt_ids)
      #print('endddddddddddddddddddddddd  iou')
    def compute_match_ioa(ioa, is_box):
      ...
      Returns:
        ...
        tp_fp_labels_group_of: boolean array of size [num_groupof_matched], all
          values are True.
      """
      #print('iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiioaa',ioa)
    ...
    if mask_mode:
      ...
      valid_entries = (~is_matched_to_difficult & ~is_matched_to_group_of)
      #print('******************************final_tp_fp',np.concatenate((tp_fp_labels[valid_entries].astype(float),tp_fp_labels_box_group_of)))
      return np.concatenate(
